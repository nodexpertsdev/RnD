    ...
    describe('check for wrong email format', () => {
      ...
      it('Without @ operator', async () => {
        const result = await chai
          ...
          .set(success.header)
          .send({
            email: error.email.withoutAtOperator,
      ...
      it('Without period(dot) ', async () => {
        const result = await chai
          ...
          .set(success.header)
          .send({
            email: error.email.withoutPeriod,
            password: success.password,
          });
        result.should.have.status(error.status);
        result.body.should.have.property('error');
      ...
      it('Without alphabetic characters', async () => {
        const result = await chai
          ...
          .set(success.header)
          .send({
            email: error.email.withoutAlphabets,
            password: success.password,
          });
        result.should.have.status(error.status);
        result.body.should.have.property('error');
    ...
    describe('check for wrong password format ', () => {
      ...
      it('Less than 8 characters', async () => {
        const result = await chai
          ...
          .send({
            ...
            password: error.password.characterCount,
          });
        result.should.have.status(error.status);
        result.body.should.have.property('error');
      });
      ...
      it('Without any capital alphabet', async () => {
        const result = await chai
          ...
          .send({
            email: success.email[0],
            password: error.password.withoutCapitalAlphabet,
          });
        result.should.have.status(error.status);
        result.body.should.have.property('error');
      });
      ...
      it('Without any small alphabet', async () => {
        const result = await chai
          ...
          .send({
            email: success.email[0],
            password: error.password.withoutSmallAlphabet,
          });
        result.should.have.status(error.status);
        result.body.should.have.property('error');
      });
      ...
      it('Without any Number', async () => {
        const result = await chai
          ...
          .send({
            email: success.email[0],
            password: error.password.withoutNumber,
          });
        result.should.have.status(error.status);
        result.body.should.have.property('error');
      });
      ...
      it('Without any special character', async () => {
        const result = await chai
          ...
          .send({
            email: success.email[0],
            password: error.password.withoutSpecialCharacter,
          });
        result.should.have.status(error.status);
        result.body.should.have.property('error');
      });
    ...
    describe('check for role', () => {
      it('With role field as supplier', async () => {
        const result = await chai
          ...
          .set(success.header)
          .send({
            email: success.email[2],
            password: success.password,
            role: success.role.supplier,
          });
        result.should.have.status(success.status);
        result.body.should.have.property('data');
        result.body.should.have.property('message');
    ...
    describe('check for contact title', () => {
      it('With contactTitle as a random string', async () => {
        const result = await chai
          ...
          .set(success.header)
          .send({
            email: success.email[6],
            password: success.password,
            contactTitle: success.companyName,
          });
        result.should.have.status(success.status);
        result.body.should.have.property('data');
        result.body.should.have.property('message');
